...
gender_employment %\>% ggplot(aes(x = year, y = wage_percent_of_male, group = major_category)) + geom_parallel_slopes(se = FALSE) + labs(x = "Years", y = "Wage Percentage Of Males")
...
simple_fit \<- lm(year \~ wage_percent_of_male, data= gender_employment)
